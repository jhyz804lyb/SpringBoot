...
import com.vuck.common.ExcelInfo;
import com.vuck.common.InitMsg;
import com.vuck.common.PageInfo;
import com.vuck.enums.Annotation;
import com.vuck.enums.OrderBy;
...
public class Util {
    ...
    public static String getRequestUrl(HttpServletRequest request) {
        ...
        while (parameterNames.hasMoreElements()) {
            ...
            int i = url.indexOf("?");
            url.append(i!=-1?("&"+nextElement+"="):("?"+nextElement+"=")).append(request.getParameter(nextElement));
        }
        return url.toString();
    }
}
