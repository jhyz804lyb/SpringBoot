...
{
    /**
     * 对请求参数注解中含有 自定义注解的注解的参数 将调用自定义的解析器
     *
     * @param parameter
     * @return
     */
    ...
    public boolean supportsParameter(MethodParameter parameter)
    {
        return parameter.getParameterAnnotation(Find.class) != null ||
                parameter.getParameterAnnotation(ImportExcel.class) != null ||
                parameter.getParameterAnnotation(Add.class) != null ||
                parameter.getParameterAnnotation(SaveOrUpdate.class) != null ||
                parameter.getParameterAnnotation(Delete.class) != null;
    }
