...
public class ForeachList extends SimpleTagSupport {
        ...
        if (fieldList == null || titleList == null) {
            ...
            temp = Util.sortArray(temp, new SortInteface() {
                public boolean compare(Object obj1, Object obj2) {
                    if (obj1 instanceof Field && obj2 instanceof Field) {
                        Field s1 = (Field) obj1;
                        Field s2 = (Field) obj2;
                        Annotation annotation1 = ReflectionUtil.getFieldAnnotation(s1, ListField.class);
                        Annotation annotatio2 = ReflectionUtil.getFieldAnnotation(s2, ListField.class);
            ...
            for (int i = 0; i < temp.length; i++) {
                if (option) {
                    ...
                    ListField showField = (ListField) ReflectionUtil.getFieldAnnotation(field, ListField.class);
                ...
                if (title) {
                    ListField showField = (ListField) ReflectionUtil.getFieldAnnotation((Field) temp[i], ListField.class);
    ...
    private String noDateMsg() {
        return "<tr class='noData warning'><td class='text-center' colspan='" + maxCell+1 + "'><h4>" + (StringUtils.isEmpty(msg) ? "没有更多数据" : msg) + "！</h4></td></tr>";
    }
